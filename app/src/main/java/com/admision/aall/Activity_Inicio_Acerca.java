...
/*
 *Activity_Inicio_Acerca: Muestra una imagen, motivación de aplicación, explicación semáforo, créditos
...
public class Activity_Inicio_Acerca extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bR = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (actual!=null) {
                    new Activity_Inicio_Acerca.ActualizarInformacion().execute();
                }
            }
        };
    }
    private  class ActualizarInformacion extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Activity_Inicio_Acerca.this.runOnUiThread(new Runnable() {
                    public void run() {
                        Personal_Alert_Dialog alerta= new Personal_Alert_Dialog();
                        alerta.showAlertDialog(Activity_Inicio_Acerca.this, "ATENCIÓN",
